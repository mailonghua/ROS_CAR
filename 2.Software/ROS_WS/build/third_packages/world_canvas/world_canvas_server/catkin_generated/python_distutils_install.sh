...
echo_and_run cd "/home/mailonghua/ros_ws/src/third_packages/world_canvas/world_canvas_server"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mailonghua/ros_ws/src/third_packages/world_canvas/world_canvas_server/setup.py" \
     \
    build --build-base "/home/mailonghua/ros_ws/build/third_packages/world_canvas/world_canvas_server" \
    install \
    --root="${DESTDIR-/}" \
